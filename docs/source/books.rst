...
.. epigraph::
   ...
   Читання -- це одне з джерел мислення та розумового розвитку.

   --- |nbsp| В. Сухомлинський
...
.. card::
   ...
   | :bdg-success-line:`2025/10` |+| "Вічне життя Смерті", *Лю Цисінь* :bdg-info:`Пам'ять Про Минуле Землі №3`
   | :bdg-success-line:`2025/07` |/| "Гіперіон", *Ден Сіммонс* :bdg-info:`Пісні Гіперіона №1`
   | :bdg-success-line:`2025/05` |/| "Мовчазна пацієнтка", *Алекс Майклідіс*
   | :bdg-success-line:`2025/02` |+| "Граф Монте-Крісто", *Александр Дюма*
   | :bdg-success-line:`2025/01` |+| "Пернач полковника Вухналя", *Борис Крамер*
